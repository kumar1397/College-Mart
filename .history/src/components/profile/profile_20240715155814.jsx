        ...
        <>
            ...
            <div className="bg-gray-900 min-h-screen flex">
                <div className="container mx-auto my-16 flex">
                    <div className="lg:w-1/3 bg-white rounded-lg shadow-lg overflow-hidden h-full fixed " style={{ marginLeft: "10%" }}>
                    ...
                    <div className="lg:ml-1/3 w-full bg-white rounded-lg shadow-lg overflow-y-auto h-full pl-8" style={{ marginLeft: "33.3333%" }}>
                        <div className="p-6">
