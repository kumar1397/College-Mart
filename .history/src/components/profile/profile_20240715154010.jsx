    ...
    return (
        <>
            ...
            <div className="bg-gray-900 h-screen flex">
                <div className="container mx-auto my-16 px-8 flex">
                    <div className="lg:w-1/3 bg-white rounded-lg shadow-lg overflow-hidden fixed h-full">
                    ...
                    <div className="lg:w-2/3 lg:ml-[33%] mt-8 lg:mt-0 bg-white rounded-lg shadow-lg overflow-y-auto h-full">
                        <div className="p-6">
