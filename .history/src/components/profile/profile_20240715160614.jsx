        ...
        <>
            ...
            <div className="bg-gray-900 min-h-screen flex">
                <div className="container mx-auto my-16 flex">
                    <div className="lg:w-1/3 bg-white rounded-lg shadow-lg overflow-hidden h-full fixed " style={{ marginRight: "65%", marginTop: "10%", marginBottom: "10%" }}>
                    ...
                    <div className="lg:ml-1/3 w-full bg-white rounded-lg shadow-lg overflow-y-auto h-full pl-8" style={{ marginLeft: "45%" , marginTop: "10%", marginBottom: "10%"}}>
                        <div className="p-6">
