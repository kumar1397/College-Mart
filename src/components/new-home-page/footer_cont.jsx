...
export default function Footer02() {
  return (
    <div className="flex flex-row justify-around  p-9 cursor-pointer">
            <div className="flex flex-col justify-center">
          <div className="font-semibold flex items-center uppercase">
            <div className="w-10 h-[2px] mr-3 bg-cyan-700"></div>The
          </div>
          <h1 className="uppercase text-[55px] md:text-[35px] leading-[1.1] font-semibold mb-4">College Mart <br />
      ...
      <footer className="bg-neutral-200 text-center text-white dark:bg-neutral-600 my-auto ">
