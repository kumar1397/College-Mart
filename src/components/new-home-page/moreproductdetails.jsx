...
const CardComponent = ({ product }) => {
  ...
  return (
    <div className="bg-white p-3 rounded-lg shadow-lg w-full h-full flex flex-row justify-between">
      ...
      <div className='w-1/2 p-4 flex flex-col justify-start border-l border-gray-200'>
        ...
        <div className='mx-4 '>
         ...
         <div>
          <form onSubmit={handleSubmit}>
            <div className=' flex items-center space-x-2 w-full mx-auto my-6'>
              <label className='text-sm font-semibold text-red-400 items-center'>Negotiate the Price</label>
              <input
                type='number'
                className='border border-gray-300 rounded-lg px-4 py-1 w-1/2 text-sm' 
              ...
              <button
                type='submit'
                className='bg-[#925FE2] hover:bg-green-400 text-white rounded-lg px-4 py-1 text-sm font-semibold'
              >
                Submit Offer
              </button>
            </div>
